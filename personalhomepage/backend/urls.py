from .views import get_article, get_chess_game, get_all_projects, get_project, get_all_chess_games_names, login, get_all_personal_chess_games_names, get_personal_chess_game
